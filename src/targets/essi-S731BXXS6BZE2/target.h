...
#define BUILD_VARIANT_LABEL \
  "essi-S731BXXS6BZE2-app-production-slide8-fops8"
#define APP_DEFAULT_FAST_KSNITCH 1
#define APP_PHYS_P0_ORACLE 0
#define APP_REQUIRE_FRESH_P0_SESSION 0
#define APP_FOPS_DATA_ALIAS_DIAG_ONLY 0
#define APP_FOPS_DATA_ALIAS_GATE_VERIFY 0
...
#define APP_PSELECT_POST_GUARD_AGE_CHECK 0
#else
...
#define ANON_PIPE_BUF_OPS_OFF 0x0121ced0UL
...
#define SLIDE_NFULNL_LOGGER_OBJECT_OFF 0x002f2a10ULL
